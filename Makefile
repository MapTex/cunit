...
pkglibexecdir = $(libexecdir)/CUnit
...
CFLAGS =  -DRELEASE=@RELEASE@ -Wall -W -pedantic -Wshadow -ansi -I/home/Administrator/CUnit/CUnit/Headers
...
LDFLAGS =  -L/home/Administrator/CUnit/CUnit/Sources
LIBOBJS = 
LIBS = 
...
VERSION_MAJOR = 2
VERSION_MINOR = 1
abs_builddir = /home/Administrator/CUnit
abs_srcdir = /home/Administrator/CUnit
abs_top_builddir = /home/Administrator/CUnit
abs_top_srcdir = /home/Administrator/CUnit
ac_ct_CC = 
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/Administrator/CUnit/install-sh
...
ZIP = zip
RPM = rpmbuild
PACKAGE_TMPSPEC = ./SPECS/CUnit-2.1-2.spec
SPECFILE = CUnit".spec"
CHANGELOG = "ChangeLog"
SOURCE_GZIP_FILE = CUnit-2.1-2.tar.gz
SOURCE_ZIP_FILE = CUnit-2.1-2.zip
SOURCE_TAR_FILE = CUnit-2.1-2.tar
...
RPM_ATHLON = ./RPMS/athlon/CUnit-2.1-2.athlon.rpm
RPM_I386 = ./RPMS/i386/CUnit-2.1-2.i386.rpm
RPM_I486 = ./RPMS/i486/CUnit-2.1-2.i486.rpm
RPM_I586 = ./RPMS/i586/CUnit-2.1-2.i586.rpm
RPM_I686 = ./RPMS/i686/CUnit-2.1-2.i686.rpm
RPM_K6 = ./RPMS/athlon/CUnit-2.1-2.k6.rpm
RPM_SRC = ./SRPMS/CUnit-2.1-2.src.rpm
...
zip: clean
	...
	${ZIP} -rT ${SOURCE_ZIP_FILE} CUnit-2.1-2/* ${ZIP_EXCLUDES} && \
	cp -f ${SOURCE_ZIP_FILE} ./CUnit-2.1-2/ && \
	cd CUnit-2.1-2
...
tarball: clean
	...
	tar cvf ${SOURCE_TAR_FILE} ${TAR_EXCLUDES} CUnit-2.1-2/* && \
	cp -f ${SOURCE_TAR_FILE} ./CUnit-2.1-2/  && \
	rm -f ${SOURCE_TAR_FILE} && \
	cd CUnit-2.1-2
